...
export type GameContext = { assign: (draw: Function) => () => any, width: number, height: number, background: number };
...
export type LayerContext = { assign: (draw: Function) => () => any, draw: () => any };
...
export type DrawableContext = { assign: (draw: Function) => () => any, draw: () => any }
